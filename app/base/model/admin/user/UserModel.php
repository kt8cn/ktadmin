...
class UserModel extends BaseModel
{
  ...
  // `mendtime` datetime DEFAULT NULL COMMENT '到期时间',
 	static public function addUser($username,$password,$telephone,$contacts,$remark=NULL,$agid,$id=NULL){
 	...
 	* 套餐升级
 	*/
 	static public function addSetmealRecord($id,$setmeal_id,$price_difference,$prices,$money,$mend_time,$year=0,$day=0,$name){
 		$uid = Session::get("uid");
 		$data["wid"] = $id;
 		$data["level_id"] = $setmeal_id;
